...
import data from './partnerProfileData.json'
...
/*
 * usePartnerProfile — 파트너 · 프로필 정보 데이터 훅
 * ------------------------------------------------------------------
 * 리더 프로필과 동일 구조이며 '내 코드'만 파트너 값(NG-SP-0004)으로 다르다.
 * 라벨(UI)은 번역, 값(코드·국가·상태 등)은 데이터 그대로. UI 키는 profile.* 재사용.
 */
